...
import AlignBottomIcon from "./icons/align-bottom.svg?react";
...
import AlignTopIcon from "./icons/align-top.svg?react";
import AlignMiddleIcon from "./icons/align-middle.svg?react";
						...
						<section className="py-16">
							<div className="px-12">
								<div className="group relative">
									...
									<h1 className="max-w-3xl text-5xl font-bold leading-[1.4] focus:outline-none">
